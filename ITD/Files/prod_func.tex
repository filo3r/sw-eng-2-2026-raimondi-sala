...
\begin{itemize}
    \item \textbf{F6. Automatic trip tracking}: this functionality was not implemented, it required a continuous stream of GPS data from the client, which was avoided to simplify the communication interface.
    \item \textbf{F.7 Automatic bike path generation}: this feature, which intended to create paths by aggregating frequently traveled user trips, was not implemented.
\end{itemize}
