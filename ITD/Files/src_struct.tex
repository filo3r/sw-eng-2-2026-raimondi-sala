...
\begin{description}
    ...
    \item[enums] Enumeration types for domain values.
...
\begin{description}
    ...
    \item[config] Configuration files for environment variables and external services.
    \item[constants] Application-wide constant values and configuration parameters.
